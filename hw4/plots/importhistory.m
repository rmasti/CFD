function q1Dhistory = importhistory(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   Q1DHISTORY = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   Q1DHISTORY = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   q1Dhistory = importfile('q1Dhistory.dat', 3, 291);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/03/08 17:40:50
