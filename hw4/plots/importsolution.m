function q1Dnozzle = importsolution(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   Q1DNOZZLE = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   Q1DNOZZLE = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   q1Dnozzle = importfile('q1Dnozzle.dat', 3, 258);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/03/08 17:50:21
