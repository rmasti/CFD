...
subplot(2,2,4)
contourf(x257, y257, num257(:,:,4))
h4 = colorbar; 
ylabel(h4,'p (Pa)')
xlabel('x'), ylabel('y')
subplot(2,2,1)
contourf(x257, y257, num257(:,:,1))
h1 = colorbar;
xlabel('x'), ylabel('y'), ylabel(h1,'\rho (kg/m^3)')
subplot(2,2,2)
contourf(x257, y257, num257(:,:,2))
h2 = colorbar;
xlabel('x'), ylabel('y'), ylabel(h2,'u (m/s)')
subplot(2,2,3)
contourf(x257, y257, num257(:,:,3))
h3 = colorbar;
xlabel('x'), ylabel('y'), ylabel(h3,'v (m/s)')
